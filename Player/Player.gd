...
onready var animationPlayer = get_node("PlayerBack/AnimationPlayer")

func _physics_process(delta):
	var input_vector = Vector2.ZERO
	input_vector.x = Input.get_action_strength("ui_key_d") - Input.get_action_strength("ui_key_a")
	input_vector.y = Input.get_action_strength("ui_key_s") - Input.get_action_strength("ui_key_w")
